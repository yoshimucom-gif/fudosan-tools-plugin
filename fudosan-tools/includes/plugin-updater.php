 ...
 *   - fudosan-tools.zip  … 配布本体
 */

if (!defined('ABSPATH')) exit;

if (!class_exists('FTL_Tools_Updater')) :

class FTL_Tools_Updater {
    private $plugin_file;
    private $plugin_slug;
    ...
    public function __construct($plugin_file, $update_url, $cache_ttl = 1800) {
        ...
        $this->cache_key       = 'ftl_tools_updater_' . md5($this->plugin_basename);
